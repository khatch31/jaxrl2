...
def main(_):
    ...
    for ep_no in tbar:
        tbar.set_description(f"[IQL {FLAGS.seed}] Ep {ep_no}/{max_online_env_steps // FLAGS.ep_length + 1}, i {i}/{FLAGS.max_offline_gradient_steps + FLAGS.max_online_gradient_steps}")
