...
--task "adroithand_door-human-v1" \
--camera_angle camera4 \
--datadir /iris/u/khatch/preliminary_experiments/model_based_offline_online/LOMPO/data/adroit_hand/door-human-v1 \
--tqdm=true \
