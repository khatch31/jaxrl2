...
XLA_PYTHON_CLIENT_PREALLOCATE=false python3 -u IQL_visualize_qfn.py \
--task "kitchen_microwave+kettle+bottom burner+light switch" \
--savefile /iris/u/khatch/vd5rl/jaxrl2/baselines_finetuning/q_visualization/CVMVE_theory/q_viz_iql.csv \
--loaddir "/iris/u/khatch/vd5rl/jaxrl2/baselines_finetuning/results/modelfree_finetuning_baselines2/kitchen_microwave+kettle+bottom burner+light switch/IQL/default/seed_3/offline_checkpoints" \
...
XLA_PYTHON_CLIENT_PREALLOCATE=false python3 -u IQL_visualize_qfn.py \
--task "kitchen_microwave+kettle+bottom burner+light switch" \
--savefile /iris/u/khatch/vd5rl/jaxrl2/baselines_finetuning/q_visualization/OOD3/q_viz_iql.csv \
--loaddir "/iris/u/khatch/vd5rl/jaxrl2/baselines_finetuning/results/modelfree_finetuning_baselines2/kitchen_microwave+kettle+bottom burner+light switch/IQL/default/seed_3/offline_checkpoints" \
